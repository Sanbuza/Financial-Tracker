...
- El dashboard responde una pregunta en 5 segundos: ¿cómo vamos este mes?
...
## Colores de avatar chips
- Santiago (S): navy blue #0F2D6B, texto blanco
- Carolina (C): warm teal #0D7377, texto blanco
- Joint: gris claro, texto oscuro
